...
from src.modules.notifications.routes.notification_routes import router as notifications_router
...
OPENAPI_TAGS = [
    {"name": "Autenticación", "description": "Inicio de sesión, registro y perfil del usuario."},
    {"name": "Usuarios", "description": "Gestión de usuarios, roles y tareas asignadas."},
    {"name": "Proyectos", "description": "Gestión de proyectos, miembros y tareas por proyecto."},
    {"name": "Tareas", "description": "Creación, asignación y seguimiento de tareas."},
    {"name": "Reportes", "description": "Reportes de desempeño, proyectos, tareas y usuarios."},
